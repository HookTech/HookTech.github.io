...
keywords: '黄金分割,斐波那契数列,数学,线性代数,特征值,特征向量,数学证明'
author: philo
---
...
得，来两张图吧！
还记得曾经的图么
![数学老师我没忘喔 - 黄金分割螺旋图](/2018/07/09/Golden-Ratio-Fibonacci/Golden-Ratio-Fibonacci-2.png)
再来张人体图吧(･ิω･ิ)
![妹子们不用看中间 - 人体黄金比例图](/2018/07/09/Golden-Ratio-Fibonacci/Golden-Ratio-Fibonacci-3.jpg)
...
### Fibonacci
先镇个楼
![Fibonacci -- Italian Mathematician - 斐波那契肖像](/2018/07/09/Golden-Ratio-Fibonacci/Golden-Ratio-Fibonacci-2.png)
